...
<svelte:head>
    <title>Bingham eClinic | Login</title>
</svelte:head>
...
<form class="form" on:submit={e => handleSub(e)} in:fly={{delay: 400, x: -500}} out:fly={{x: 500}}>
    ...
    <section>
        ...
        <div>
            ...
            <a href="#f" class="underline hover:no-underline">Forgot password?</a>
        </div>

        <Button type={'submit'} light={true}>Login</Button>
        <p>Don't have an account yet? <a href="/signup" class="underline hover:no-underline">Signup</a></p>
    </section>
</form>
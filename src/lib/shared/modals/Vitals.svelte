...
<article>
    ...
    <section transition:fade={{delay: 250}}>
        <h2 class="text-xl font-bold">Enter Patient's Vitals</h2>
        <form class="flex flex-col gap-2.5">
            <input type="number" name="Temperature" required placeholder="Enter Temperature">
            ...
            <input type="number" name="BloodPressure" required placeholder="Enter Blood Pressure">
            <Button light='true' full='true'>Add Vitals</Button>
        </form>
    </section>
</article>

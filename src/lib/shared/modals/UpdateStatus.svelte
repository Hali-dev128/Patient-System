...
<article>
    ...
    <section transition:fade={{delay: 250}}>
        <h2 class="text-xl font-bold">Update Patient's Status</h2>

        <div class="flex gap-2 flex-wrap">
            <Button light='true'>Done</Button>
            <Button light='true'>Waiting</Button>
            <Button light='true'>In Consultation</Button>
        </div>
    </section>
</article>
